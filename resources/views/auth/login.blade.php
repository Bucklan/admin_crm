                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary @error('password') has-danger @enderror">
                                    <label class="control-label">@lang('Пароль') <span
                                            class="text-danger">*</span></label>
